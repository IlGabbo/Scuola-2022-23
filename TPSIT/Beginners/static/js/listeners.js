document.getElementById("ex1Submit").addEventListener("click", function () {
...
document.getElementById("ex2Submit").addEventListener("click", function () {
    let vote = document.getElementById("ex2Vote").value;
    document.getElementById("ex2Result").innerHTML = Vote(vote);
})

document.getElementById("ex3Submit").addEventListener("click", function () {
...
document.getElementById("ex4Submit").addEventListener("click", function () {
...
document.getElementById("ex5Submit").addEventListener("click", function () {
